...
";
            string expectedOperationTree = @"
IReturnStatement ([0] OperationKind.YieldReturnStatement) (Syntax: YieldReturnStatement, 'yield return 0;') (Parent: BlockStatement)
  ReturnedValue: 
...
";
            string expectedOperationTree = @"
IReturnStatement ([1] OperationKind.YieldBreakStatement) (Syntax: YieldBreakStatement, 'yield break;') (Parent: BlockStatement)
  ReturnedValue: 
    null
";
            var expectedDiagnostics = DiagnosticDescription.None;
