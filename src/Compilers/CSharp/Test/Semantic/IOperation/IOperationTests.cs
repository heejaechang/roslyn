...
@"IInvocationExpression (void Cls.Test1(params System.Int32[] x)) ([0] OperationKind.InvocationExpression, Type: System.Void) (Syntax: InvocationExpression, 'Test1(null)') (Parent: ExpressionStatement)
  Instance Receiver: 
    null
  Arguments(1):
    IArgument (ArgumentKind.Explicit, Matching Parameter: x) ([0] OperationKind.Argument) (Syntax: Argument, 'null')
...
@"IInvalidExpression ([0] OperationKind.InvalidExpression, Type: System.Void, IsInvalid) (Syntax: InvocationExpression, 'Test2(new o ... ct(), null)') (Parent: ExpressionStatement)
  Children(2):
