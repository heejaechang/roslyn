...
IInstanceReferenceExpression ([0] OperationKind.InstanceReferenceExpression, Type: C1) (Syntax: BaseExpression, 'base') (Parent: InvocationExpression)
";
...
";
            string expectedOperationTree = @"
IInstanceReferenceExpression ([0] OperationKind.InstanceReferenceExpression, Type: System.Object) (Syntax: BaseExpression, 'base') (Parent: InvalidExpression)
";
