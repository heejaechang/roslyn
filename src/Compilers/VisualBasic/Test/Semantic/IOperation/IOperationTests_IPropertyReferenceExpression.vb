...
IPropertyReferenceExpression: Property M1.C1.P1 As System.Object ([0] OperationKind.PropertyReferenceExpression, Type: System.Object) (Syntax: IdentifierName, 'P1') (Parent: SimpleAssignmentExpression)
  Instance Receiver: 
    IInstanceReferenceExpression ([0] OperationKind.InstanceReferenceExpression, Type: M1.C2, IsImplicit) (Syntax: ObjectCreationExpression, 'New C2 With ... New Object}')
]]>.Value
...
End Module]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IPropertyReferenceExpression: Property M1.C1.P1 As System.Object ([1] OperationKind.PropertyReferenceExpression, Type: System.Object) (Syntax: SimpleMemberAccessExpression, '.P1') (Parent: SimpleAssignmentExpression)
  Instance Receiver: 
    IInstanceReferenceExpression ([0] OperationKind.InstanceReferenceExpression, Type: M1.C2, IsImplicit) (Syntax: ObjectCreationExpression, 'New C2 With {.P2 = .P1}')
]]>.Value
