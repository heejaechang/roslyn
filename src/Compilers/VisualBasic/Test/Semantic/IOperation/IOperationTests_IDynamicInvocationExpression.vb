...
IDynamicInvocationExpression ([0] OperationKind.DynamicInvocationExpression, Type: System.Object) (Syntax: InvocationExpression, 'c.M2(d)') (Parent: ExpressionStatement)
  Expression: 
    IDynamicMemberReferenceExpression (Member Name: "M2", Containing Type: null) ([0] OperationKind.DynamicMemberReferenceExpression, Type: System.Object) (Syntax: SimpleMemberAccessExpression, 'c.M2')
      Type Arguments(0)
      Instance Receiver: 
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IDynamicInvocationExpression ([0] OperationKind.DynamicInvocationExpression, Type: System.Object) (Syntax: InvocationExpression, 'M2(d)') (Parent: ExpressionStatement)
  Expression: 
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IDynamicInvocationExpression ([0] OperationKind.DynamicInvocationExpression, Type: System.Object) (Syntax: InvocationExpression, 'M2(d, e)') (Parent: ExpressionStatement)
  Expression: 
    IDynamicMemberReferenceExpression (Member Name: "M2", Containing Type: null) ([0] OperationKind.DynamicMemberReferenceExpression, Type: System.Object) (Syntax: IdentifierName, 'M2')
      Type Arguments(0)
      Instance Receiver: 
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IDynamicInvocationExpression ([0] OperationKind.DynamicInvocationExpression, Type: System.Object) (Syntax: InvocationExpression, 'M2(d:=d, c:=e)') (Parent: ExpressionStatement)
  Expression: 
    IDynamicMemberReferenceExpression (Member Name: "M2", Containing Type: null) ([0] OperationKind.DynamicMemberReferenceExpression, Type: System.Object) (Syntax: IdentifierName, 'M2')
      Type Arguments(0)
      Instance Receiver: 
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IInvalidExpression ([0] OperationKind.InvalidExpression, Type: System.Void, IsInvalid) (Syntax: InvocationExpression, 'M2(d)') (Parent: ExpressionStatement)
  Children(2):
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IDynamicInvocationExpression ([0] OperationKind.DynamicInvocationExpression, Type: System.Object) (Syntax: InvocationExpression, 'c(d)') (Parent: VariableInitializer)
  Expression: 
    IDynamicMemberReferenceExpression (Member Name: "P1", Containing Type: null) ([0] OperationKind.DynamicMemberReferenceExpression, Type: System.Object) (Syntax: IdentifierName, 'c')
      Type Arguments(0)
      Instance Receiver: 
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IDynamicInvocationExpression ([0] OperationKind.DynamicInvocationExpression, Type: System.Object) (Syntax: InvocationExpression, 'c(d, d)') (Parent: VariableInitializer)
  Expression: 
    IDynamicMemberReferenceExpression (Member Name: "P1", Containing Type: null) ([0] OperationKind.DynamicMemberReferenceExpression, Type: System.Object) (Syntax: IdentifierName, 'c')
      Type Arguments(0)
      Instance Receiver: 
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IDynamicInvocationExpression ([0] OperationKind.DynamicInvocationExpression, Type: System.Object) (Syntax: InvocationExpression, 'c(x2:=e, x:=d)') (Parent: VariableInitializer)
  Expression: 
    IDynamicMemberReferenceExpression (Member Name: "P1", Containing Type: null) ([0] OperationKind.DynamicMemberReferenceExpression, Type: System.Object) (Syntax: IdentifierName, 'c')
      Type Arguments(0)
      Instance Receiver: 
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IInvocationExpression (virtual Sub C.MySubDelegate.Invoke(x As System.Int32)) ([0] OperationKind.InvocationExpression, Type: System.Void) (Syntax: InvocationExpression, 'd(o)') (Parent: ExpressionStatement)
  Instance Receiver: 
    IParameterReferenceExpression: d ([0] OperationKind.ParameterReferenceExpression, Type: C.MySubDelegate) (Syntax: IdentifierName, 'd')
  Arguments(1):
    IArgument (ArgumentKind.Explicit, Matching Parameter: x) ([1] OperationKind.Argument) (Syntax: SimpleArgument, 'o')
      IConversionExpression (Implicit, TryCast: False, Unchecked) ([0] OperationKind.ConversionExpression, Type: System.Int32, IsImplicit) (Syntax: IdentifierName, 'o')
...
IDynamicInvocationExpression ([0] OperationKind.DynamicInvocationExpression, Type: System.Object) (Syntax: InvocationExpression, 'c(d)(d)') (Parent: VariableInitializer)
  Expression: 
    IDynamicInvocationExpression ([0] OperationKind.DynamicInvocationExpression, Type: System.Object) (Syntax: InvocationExpression, 'c(d)')
      Expression: 
        IDynamicMemberReferenceExpression (Member Name: "P1", Containing Type: null) ([0] OperationKind.DynamicMemberReferenceExpression, Type: System.Object) (Syntax: IdentifierName, 'c')
          Type Arguments(0)
          Instance Receiver: 
